...
(function () {
  ...
  var CHANGELOG = [
    { v: 'v60', items: [
      'Видео теперь хранится на своей виртуалке (не у Yandex) — старые ролики перенесены, ничего не потеряно',
      'В Настройках видно свободное место на диске; при отправке видео оно же коротко в сообщении об успехе',
      '«Режим Папич» в Настройках — заставка при открытии и фон в чате, можно выключить одним переключателем'
    ] }
  ];
